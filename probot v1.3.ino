...
const float AUTO_TURN_POWER = 1.0f;  // saga donus icin
const float AUTO_TURN_TOLERANCE = 8.0f;
const unsigned long AUTO_FWD_MS = 1300;
...
void teleopLoop() {
  ...
  float maxP = max({ 1.0f, fabs(tFL), fabs(tFR), fabs(tRL), fabs(tRR) });
